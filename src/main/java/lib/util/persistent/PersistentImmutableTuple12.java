...
public class PersistentImmutableTuple12<T1 extends AnyPersistent, T2 extends AnyPersistent, T3 extends AnyPersistent, T4 extends AnyPersistent, T5 extends AnyPersistent, T6 extends AnyPersistent, T7 extends AnyPersistent, T8 extends AnyPersistent, T9 extends AnyPersistent, T10 extends AnyPersistent, T11 extends AnyPersistent, T12 extends AnyPersistent> extends PersistentImmutableObject {
    ...
    public static final ObjectType<PersistentImmutableTuple12> TYPE = ObjectType.withFields(PersistentImmutableTuple12.class, FIELD1, FIELD2, FIELD3, FIELD4, FIELD5, FIELD6, FIELD7, FIELD8, FIELD9, FIELD10, FIELD11, FIELD12);
    ...
    protected PersistentImmutableTuple12(ObjectType<? extends PersistentImmutableTuple12> type, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10, T11 t11, T12 t12) {
        super(type, (PersistentImmutableTuple12 self) -> {
            Transaction.run(() -> {
    ...
    protected PersistentImmutableTuple12(ObjectPointer<? extends PersistentImmutableTuple12> p) {super(p);}
