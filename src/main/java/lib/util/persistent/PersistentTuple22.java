...
public class PersistentTuple22<T1 extends PersistentObject, T2 extends PersistentObject, T3 extends PersistentObject, T4 extends PersistentObject, T5 extends PersistentObject, T6 extends PersistentObject, T7 extends PersistentObject, T8 extends PersistentObject, T9 extends PersistentObject, T10 extends PersistentObject, T11 extends PersistentObject, T12 extends PersistentObject, T13 extends PersistentObject, T14 extends PersistentObject, T15 extends PersistentObject, T16 extends PersistentObject, T17 extends PersistentObject, T18 extends PersistentObject, T19 extends PersistentObject, T20 extends PersistentObject, T21 extends PersistentObject, T22 extends PersistentObject> extends PersistentObject {
    ...
    public static final ObjectType<PersistentTuple22> TYPE = ObjectType.fromFields(PersistentTuple22.class, FIELD1, FIELD2, FIELD3, FIELD4, FIELD5, FIELD6, FIELD7, FIELD8, FIELD9, FIELD10, FIELD11, FIELD12, FIELD13, FIELD14, FIELD15, FIELD16, FIELD17, FIELD18, FIELD19, FIELD20, FIELD21, FIELD22);
    ...
    protected PersistentTuple22(ObjectPointer<? extends PersistentTuple22> p) {super(p);}
    ...
    @SuppressWarnings("unchecked")
        public synchronized T20 _20() {
            return (T20)getObjectField(FIELD20);
        }

    @SuppressWarnings("unchecked")
        public synchronized T21 _21() {
            return (T21)getObjectField(FIELD21);
        }

    @SuppressWarnings("unchecked")
        public synchronized T22 _22() {
    ...
    public synchronized void _22(T22 t22) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof PersistentTuple22)) return false;

        PersistentTuple22 that = (PersistentTuple22)obj;
