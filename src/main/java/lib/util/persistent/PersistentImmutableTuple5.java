...
@PersistentClass
public class PersistentImmutableTuple5<T1 extends PersistentObject, T2 extends PersistentObject, T3 extends PersistentObject, T4 extends PersistentObject, T5 extends PersistentObject> extends PersistentObject {
    ...
    public static final ObjectType<PersistentImmutableTuple5> TYPE = ObjectType.fromFields(PersistentImmutableTuple5.class, FIELD1, FIELD2, FIELD3, FIELD4, FIELD5);
