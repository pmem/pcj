...
public class PersistentImmutableTuple10<T1 extends AnyPersistent, T2 extends AnyPersistent, T3 extends AnyPersistent, T4 extends AnyPersistent, T5 extends AnyPersistent, T6 extends AnyPersistent, T7 extends AnyPersistent, T8 extends AnyPersistent, T9 extends AnyPersistent, T10 extends AnyPersistent> extends PersistentImmutableObject {
    ...
    public static final ObjectType<PersistentImmutableTuple10> TYPE = ObjectType.fromFields(PersistentImmutableTuple10.class, FIELD1, FIELD2, FIELD3, FIELD4, FIELD5, FIELD6, FIELD7, FIELD8, FIELD9, FIELD10);
