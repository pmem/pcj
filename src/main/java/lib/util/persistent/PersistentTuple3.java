...
public class PersistentTuple3<T1 extends PersistentObject, T2 extends PersistentObject, T3 extends PersistentObject> extends PersistentObject {
    ...
    public static final ObjectType<PersistentTuple3> TYPE = ObjectType.fromFields(PersistentTuple3.class, FIELD1, FIELD2, FIELD3);
