...
@PersistentClass
public class PersistentImmutableTuple4<T1 extends PersistentObject, T2 extends PersistentObject, T3 extends PersistentObject, T4 extends PersistentObject> extends PersistentObject {
    ...
    public static final ObjectType<PersistentImmutableTuple4> TYPE = ObjectType.fromFields(PersistentImmutableTuple4.class, FIELD1, FIELD2, FIELD3, FIELD4);
