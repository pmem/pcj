...
public final class PersistentCharArray extends AbstractPersistentMutableArray {
    private static final ArrayType<PersistentCharArray> TYPE = new ReferenceArrayType<>(PersistentCharArray.class, Types.CHAR);
