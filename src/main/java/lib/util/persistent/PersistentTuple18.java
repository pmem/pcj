...
public class PersistentTuple18<T1 extends PersistentObject, T2 extends PersistentObject, T3 extends PersistentObject, T4 extends PersistentObject, T5 extends PersistentObject, T6 extends PersistentObject, T7 extends PersistentObject, T8 extends PersistentObject, T9 extends PersistentObject, T10 extends PersistentObject, T11 extends PersistentObject, T12 extends PersistentObject, T13 extends PersistentObject, T14 extends PersistentObject, T15 extends PersistentObject, T16 extends PersistentObject, T17 extends PersistentObject, T18 extends PersistentObject> extends PersistentObject {
    ...
    public static final ObjectType<PersistentTuple18> TYPE = ObjectType.fromFields(PersistentTuple18.class, FIELD1, FIELD2, FIELD3, FIELD4, FIELD5, FIELD6, FIELD7, FIELD8, FIELD9, FIELD10, FIELD11, FIELD12, FIELD13, FIELD14, FIELD15, FIELD16, FIELD17, FIELD18);
    ...
    protected PersistentTuple18(ObjectPointer<? extends PersistentTuple18> p) {super(p);}
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof PersistentTuple18)) return false;

        PersistentTuple18 that = (PersistentTuple18)obj;
