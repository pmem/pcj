...
@PersistentClass
public class PersistentImmutableTuple22<T1 extends PersistentObject, T2 extends PersistentObject, T3 extends PersistentObject, T4 extends PersistentObject, T5 extends PersistentObject, T6 extends PersistentObject, T7 extends PersistentObject, T8 extends PersistentObject, T9 extends PersistentObject, T10 extends PersistentObject, T11 extends PersistentObject, T12 extends PersistentObject, T13 extends PersistentObject, T14 extends PersistentObject, T15 extends PersistentObject, T16 extends PersistentObject, T17 extends PersistentObject, T18 extends PersistentObject, T19 extends PersistentObject, T20 extends PersistentObject, T21 extends PersistentObject, T22 extends PersistentObject> extends PersistentObject {
    ...
    private static final ObjectField<PersistentObject> FIELD18 = new ObjectField<>();
    private static final ObjectField<PersistentObject> FIELD19 = new ObjectField<>();
    private static final ObjectField<PersistentObject> FIELD20 = new ObjectField<>();
    private static final ObjectField<PersistentObject> FIELD21 = new ObjectField<>();
    private static final ObjectField<PersistentObject> FIELD22 = new ObjectField<>();
    public static final ObjectType<PersistentImmutableTuple22> TYPE = ObjectType.fromFields(PersistentImmutableTuple22.class, FIELD1, FIELD2, FIELD3, FIELD4, FIELD5, FIELD6, FIELD7, FIELD8, FIELD9, FIELD10, FIELD11, FIELD12, FIELD13, FIELD14, FIELD15, FIELD16, FIELD17, FIELD18, FIELD19, FIELD20, FIELD21, FIELD22);
    ...
    public PersistentImmutableTuple22(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10, T11 t11, T12 t12, T13 t13, T14 t14, T15 t15, T16 t16, T17 t17, T18 t18, T19 t19, T20 t20, T21 t21, T22 t22) {
        this(TYPE, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22);
    }
    ...
    protected PersistentImmutableTuple22(ObjectPointer<? extends PersistentImmutableTuple22> p) {super(p);}
    ...
    @SuppressWarnings("unchecked")
        public T22 _22() {
            return (T22)getObjectField(FIELD22);
        }
    ...
    private void _19(T19 t19) {
            setObjectField(FIELD19, t19);
        }

    private void _20(T20 t20) {
            setObjectField(FIELD20, t20);
        }

    private void _21(T21 t21) {
            setObjectField(FIELD21, t21);
        }

    private void _22(T22 t22) {
            setObjectField(FIELD22, t22);
        }

    public String toString() {
        return "Tuple22(" + _1() + ", " + _2() + ", " + _3() + ", " + _4() + ", " + _5() + ", " + _6() + ", " + _7() + ", " + _8() + ", " + _9() + ", " + _10() + ", " + _11() + ", " + _12() + ", " + _13() + ", " + _14() + ", " + _15() + ", " + _16() + ", " + _17() + ", " + _18() + ", " + _19() + ", " + _20() + ", " + _21() + ", " + _22() + ")";
    }
