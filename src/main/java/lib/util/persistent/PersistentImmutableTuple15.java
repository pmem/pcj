...
@PersistentClass
public class PersistentImmutableTuple15<T1 extends PersistentObject, T2 extends PersistentObject, T3 extends PersistentObject, T4 extends PersistentObject, T5 extends PersistentObject, T6 extends PersistentObject, T7 extends PersistentObject, T8 extends PersistentObject, T9 extends PersistentObject, T10 extends PersistentObject, T11 extends PersistentObject, T12 extends PersistentObject, T13 extends PersistentObject, T14 extends PersistentObject, T15 extends PersistentObject> extends PersistentObject {
    ...
    public static final ObjectType<PersistentImmutableTuple15> TYPE = ObjectType.fromFields(PersistentImmutableTuple15.class, FIELD1, FIELD2, FIELD3, FIELD4, FIELD5, FIELD6, FIELD7, FIELD8, FIELD9, FIELD10, FIELD11, FIELD12, FIELD13, FIELD14, FIELD15);
    ...
    public PersistentImmutableTuple15(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10, T11 t11, T12 t12, T13 t13, T14 t14, T15 t15) {
        this(TYPE, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15);
    }
    ...
    protected PersistentImmutableTuple15(ObjectPointer<? extends PersistentImmutableTuple15> p) {super(p);}
    ...
    public String toString() {
        return "Tuple15(" + _1() + ", " + _2() + ", " + _3() + ", " + _4() + ", " + _5() + ", " + _6() + ", " + _7() + ", " + _8() + ", " + _9() + ", " + _10() + ", " + _11() + ", " + _12() + ", " + _13() + ", " + _14() + ", " + _15() + ")";
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof PersistentImmutableTuple15)) return false;

        PersistentImmutableTuple15 that = (PersistentImmutableTuple15)obj;
