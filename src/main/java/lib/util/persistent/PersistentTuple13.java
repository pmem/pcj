...
public class PersistentTuple13<T1 extends PersistentObject, T2 extends PersistentObject, T3 extends PersistentObject, T4 extends PersistentObject, T5 extends PersistentObject, T6 extends PersistentObject, T7 extends PersistentObject, T8 extends PersistentObject, T9 extends PersistentObject, T10 extends PersistentObject, T11 extends PersistentObject, T12 extends PersistentObject, T13 extends PersistentObject>
  extends PersistentObject {
    ...
    public static final ObjectType<PersistentTuple13> TYPE = ObjectType.fromFields(PersistentTuple13.class, FIELD1, FIELD2, FIELD3, FIELD4, FIELD5, FIELD6, FIELD7, FIELD8, FIELD9, FIELD10, FIELD11, FIELD12, FIELD13);
    ...
    protected PersistentTuple13(ObjectPointer<? extends PersistentTuple13> p) {super(p);}
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof PersistentTuple13)) return false;

        PersistentTuple13 that = (PersistentTuple13)obj;
