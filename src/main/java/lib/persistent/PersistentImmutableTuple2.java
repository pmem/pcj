...
public class PersistentImmutableTuple2<T1 extends Persistent, T2 extends Persistent> implements Persistent {
    ...
    public PersistentImmutableTuple2() {
        this(null, null);
    }

    public PersistentImmutableTuple2(T1 t1, T2 t2) {
        synchronized (PersistentImmutableTuple2.class) {
            Transaction.run(() -> {
