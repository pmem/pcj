...
public class PersistentTuple7<T1 extends Persistent, T2 extends Persistent, T3 extends Persistent, T4 extends Persistent, T5 extends Persistent, T6 extends Persistent, T7 extends Persistent> implements Persistent {
    ...
    public PersistentTuple7(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7) {
        synchronized (PersistentTuple7.class) {
            Transaction.run(() -> {
