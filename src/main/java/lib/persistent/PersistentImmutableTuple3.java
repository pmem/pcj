...
public class PersistentImmutableTuple3<T1 extends Persistent, T2 extends Persistent, T3 extends Persistent> implements Persistent {
    ...
    public PersistentImmutableTuple3() {
        this(null, null, null);
    }

    public PersistentImmutableTuple3(T1 t1, T2 t2, T3 t3) {
        synchronized (PersistentImmutableTuple3.class) {
            Transaction.run(() -> {
