...
public class PersistentImmutableTuple22<T1 extends Persistent, T2 extends Persistent, T3 extends Persistent, T4 extends Persistent, T5 extends Persistent, T6 extends Persistent, T7 extends Persistent, T8 extends Persistent, T9 extends Persistent, T10 extends Persistent, T11 extends Persistent, T12 extends Persistent, T13 extends Persistent, T14 extends Persistent, T15 extends Persistent, T16 extends Persistent, T17 extends Persistent, T18 extends Persistent, T19 extends Persistent, T20 extends Persistent, T21 extends Persistent, T22 extends Persistent> implements Persistent {
    ...
    public PersistentImmutableTuple22() {
    ...
    public PersistentImmutableTuple22(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10, T11 t11, T12 t12, T13 t13, T14 t14, T15 t15, T16 t16, T17 t17, T18 t18, T19 t19, T20 t20, T21 t21, T22 t22) {
        synchronized (PersistentImmutableTuple22.class) {
            Transaction.run(() -> {
                this.offset = Aggregation.nativeAggregate(this.getClass().getName(), 22);
                _1(t1);
                _2(t2);
                _3(t3);
                _4(t4);
    ...
    private synchronized void _12(T12 t12) {
        Transaction.run(() -> {
    ...
    private synchronized void _13(T13 t13) {
        Transaction.run(() -> {
    ...
    private synchronized void _14(T14 t14) {
        Transaction.run(() -> {
    ...
    private synchronized void _15(T15 t15) {
        Transaction.run(() -> {
    ...
    private synchronized void _16(T16 t16) {
        Transaction.run(() -> {
    ...
    private synchronized void _17(T17 t17) {
        Transaction.run(() -> {
    ...
    private synchronized void _18(T18 t18) {
        Transaction.run(() -> {
    ...
    private synchronized void _19(T19 t19) {
        Transaction.run(() -> {
    ...
    private synchronized void _20(T20 t20) {
        Transaction.run(() -> {
    ...
    private synchronized void _21(T21 t21) {
        Transaction.run(() -> {
    ...
    private synchronized void _22(T22 t22) {
        Transaction.run(() -> {
            long off = t22 == null ? 0 : t22.getOffset();
            Aggregation.nativeSetField(this.getOffset(), 21, off);
        });
    }
    ...
    public synchronized int hashCode() {
        return _1().hashCode() + _2().hashCode() + _3().hashCode() + _4().hashCode() + _5().hashCode() + _6().hashCode() + _7().hashCode() + _8().hashCode() + _9().hashCode() + _10().hashCode() + _11().hashCode() + _12().hashCode() + _13().hashCode() + _14().hashCode() + _15().hashCode() + _16().hashCode() + _17().hashCode() + _18().hashCode() + _19().hashCode() + _20().hashCode() + _21().hashCode() + _22().hashCode();
    }

    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof PersistentImmutableTuple22)) return false;

        PersistentImmutableTuple22 that = (PersistentImmutableTuple22)obj;
    ...
    public synchronized String toString() {
        return "{" + _1().toString() + ", " + _2().toString() + ", " + _3().toString() + ", " + _4().toString() + ", " + _5().toString() + ", " + _6().toString() + ", " + _7().toString() + ", " + _8().toString() + ", " + _9().toString() + ", " + _10().toString() + ", " + _11().toString() + ", " + _12().toString() + ", " + _13().toString() + ", " + _14().toString() + ", " + _15().toString() + ", " + _16().toString() + ", " + _17().toString() + ", " + _18().toString() + ", " + _19().toString() + ", " + _20().toString() + ", " + _21().toString() + ", " + _22().toString() + "}";
    }
}
