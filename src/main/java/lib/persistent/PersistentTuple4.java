...
public class PersistentTuple4<T1 extends Persistent, T2 extends Persistent, T3 extends Persistent, T4 extends Persistent> implements Persistent {
    ...
    public PersistentTuple4(T1 t1, T2 t2, T3 t3, T4 t4) {
        synchronized (PersistentTuple4.class) {
            Transaction.run(() -> {
