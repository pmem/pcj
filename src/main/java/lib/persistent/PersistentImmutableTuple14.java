...
public class PersistentImmutableTuple14<T1 extends Persistent, T2 extends Persistent, T3 extends Persistent, T4 extends Persistent, T5 extends Persistent, T6 extends Persistent, T7 extends Persistent, T8 extends Persistent, T9 extends Persistent, T10 extends Persistent, T11 extends Persistent, T12 extends Persistent, T13 extends Persistent, T14 extends Persistent> implements Persistent {
    ...
    public PersistentImmutableTuple14() {
    ...
    public PersistentImmutableTuple14(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10, T11 t11, T12 t12, T13 t13, T14 t14) {
        synchronized (PersistentImmutableTuple14.class) {
            Transaction.run(() -> {
                this.offset = Aggregation.nativeAggregate(this.getClass().getName(), 14);
                _1(t1);
                _2(t2);
                _3(t3);
                _4(t4);
    ...
    public synchronized String toString() {
        return "{" + _1().toString() + ", " + _2().toString() + ", " + _3().toString() + ", " + _4().toString() + ", " + _5().toString() + ", " + _6().toString() + ", " + _7().toString() + ", " + _8().toString() + ", " + _9().toString() + ", " + _10().toString() + ", " + _11().toString() + ", " + _12().toString() + ", " + _13().toString() + ", " + _14().toString() + "}";
    }
}
