...
public class PersistentTuple6<T1 extends Persistent, T2 extends Persistent, T3 extends Persistent, T4 extends Persistent, T5 extends Persistent, T6 extends Persistent> implements Persistent {
    ...
    public PersistentTuple6(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6) {
        synchronized (PersistentTuple6.class) {
            Transaction.run(() -> {
                this.offset = Aggregation.nativeAggregate(this.getClass().getName(), 6);
                _1(t1);
                _2(t2);
                _3(t3);
                _4(t4);
    ...
    public synchronized String toString() {
        return "{" + _1().toString() + ", " + _2().toString() + ", " + _3().toString() + ", " + _4().toString() + ", " + _5().toString() + ", " + _6().toString() + "}";
    }
}