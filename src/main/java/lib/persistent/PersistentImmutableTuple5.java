...
public class PersistentImmutableTuple5<T1 extends Persistent, T2 extends Persistent, T3 extends Persistent, T4 extends Persistent, T5 extends Persistent> implements Persistent {
    ...
    public PersistentImmutableTuple5() {
        this(null, null, null, null, null);
    }

    public PersistentImmutableTuple5(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5) {
        synchronized (PersistentImmutableTuple5.class) {
            Transaction.run(() -> {
