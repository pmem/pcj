...
public interface Transaction
{
    ...
    public static void run(Update update) {
        run(PersistentMemoryProvider.defaultProvider(), update);
    }

    public static Transaction newInstance() {
        return PersistentMemoryProvider.defaultProvider().newTransaction();
    }

    public static Transaction startTransaction() {
        return PersistentMemoryProvider.defaultProvider().newTransaction().start();
    }
