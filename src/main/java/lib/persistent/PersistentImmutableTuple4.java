...
public class PersistentImmutableTuple4<T1 extends Persistent, T2 extends Persistent, T3 extends Persistent, T4 extends Persistent> implements Persistent {
    ...
    public PersistentImmutableTuple4() {
        this(null, null, null, null);
    }

    public PersistentImmutableTuple4(T1 t1, T2 t2, T3 t3, T4 t4) {
        synchronized (PersistentImmutableTuple4.class) {
            Transaction.run(() -> {
                this.offset = Aggregation.nativeAggregate(this.getClass().getName(), 4);
                _1(t1);
                _2(t2);
                _3(t3);
                _4(t4);
