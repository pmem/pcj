...
public class PersistentImmutableTuple18<T1 extends Persistent, T2 extends Persistent, T3 extends Persistent, T4 extends Persistent, T5 extends Persistent, T6 extends Persistent, T7 extends Persistent, T8 extends Persistent, T9 extends Persistent, T10 extends Persistent, T11 extends Persistent, T12 extends Persistent, T13 extends Persistent, T14 extends Persistent, T15 extends Persistent, T16 extends Persistent, T17 extends Persistent, T18 extends Persistent> implements Persistent {
    ...
    public PersistentImmutableTuple18() {
    ...
    public PersistentImmutableTuple18(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10, T11 t11, T12 t12, T13 t13, T14 t14, T15 t15, T16 t16, T17 t17, T18 t18) {
        synchronized (PersistentImmutableTuple18.class) {
            Transaction.run(() -> {
                this.offset = Aggregation.nativeAggregate(this.getClass().getName(), 18);
                _1(t1);
                _2(t2);
                _3(t3);
                _4(t4);
    ...
    public synchronized int hashCode() {
        return _1().hashCode() + _2().hashCode() + _3().hashCode() + _4().hashCode() + _5().hashCode() + _6().hashCode() + _7().hashCode() + _8().hashCode() + _9().hashCode() + _10().hashCode() + _11().hashCode() + _12().hashCode() + _13().hashCode() + _14().hashCode() + _15().hashCode() + _16().hashCode() + _17().hashCode() + _18().hashCode();
    }

    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof PersistentImmutableTuple18)) return false;

        PersistentImmutableTuple18 that = (PersistentImmutableTuple18)obj;
    ...
    public synchronized String toString() {
        return "{" + _1().toString() + ", " + _2().toString() + ", " + _3().toString() + ", " + _4().toString() + ", " + _5().toString() + ", " + _6().toString() + ", " + _7().toString() + ", " + _8().toString() + ", " + _9().toString() + ", " + _10().toString() + ", " + _11().toString() + ", " + _12().toString() + ", " + _13().toString() + ", " + _14().toString() + ", " + _15().toString() + ", " + _16().toString() + ", " + _17().toString() + ", " + _18().toString() + "}";
    }
}
