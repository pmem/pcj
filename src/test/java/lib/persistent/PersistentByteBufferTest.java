...
public class PersistentByteBufferTest {
    ...
    public static void testBufferPosition() {
        ...
        PersistentByteBuffer buf2 = PersistentByteBuffer.fromOffset(buf.getOffset());
        Util.incRef(buf.getOffset());
    ...
    public static void testBufferClear() {
        ...
        PersistentByteBuffer buf3 = PersistentByteBuffer.fromOffset(buf2.getOffset());
        Util.incRef(buf.getOffset());

        assert(buf3.limit() == 15);
        assert(buf3.position() == 0);

        assert(TestUtil.shouldEqual(buf3, "hellojavaworld!"));
    }
    ...
    public static void testBufferBasicPutsGets() {
        ...
        assert(TestUtil.shouldEqual(buf, "hellojavaworld!"));
        ...
        assert(TestUtil.shouldEqual(buf, "hellohavaworld!"));

        buf.position(5);
        temp.put("ruby".getBytes());
        temp.rewind();
        buf.put(temp);
        assert(TestUtil.shouldEqual(buf, "hellorubyworld!"));
